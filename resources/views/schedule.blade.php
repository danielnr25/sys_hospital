        ...
        <div class="table-responsive">
            <table class="table align-items-center table-flush">
                <thead class="thead-light">
                    <tr>
                        <th scope="col" class="text-dark text-xs">Día</th>
                        <th scope="col" class="text-dark text-xs">Activo</th>
                        <th scope="col" class="text-dark text-xs">Turno mañana</th>
                        <th scope="col" class="text-dark text-xs">Turno tarde</th>
                    </tr>
                </thead>
                <tbody class="text-default">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <div class="col">
                                    <select class="form-control text-default" name="morning_start[]">
                                        @for ($i=5; $i<=11; $i++) <option value="{{ ($i<10 ? '0' : '') . $i }}:00" @if($i.':00 AM'==$workDay->morning_start) selected @endif>
                                            {{ $i }}:00 AM
                                            </option>
                                ...
                                <div class="col">
                                    <select class="form-control text-default" name="morning_end[]">
                                        @for ($i=5; $i<=11; $i++) <option value="{{ ($i<10 ? '0' : '') . $i }}:00" @if($i.':00 AM'==$workDay->morning_end) selected @endif>
                                            {{ $i }}:00 AM
                                            </option>
                        ...
                        <td>
                            <div class="row">
                                <div class="col">
                                    <select class="form-control text-default" name="afternoon_start[]">
                                ...
                                <div class="col">
                                    <select class="form-control text-default" name="afternoon_end[]">
